...
double HelperFunction::pterr( TObject *o, bool isData){
  ...
  if ((gsf = dynamic_cast<TElectron *> (&(*o)) ) != 0)
  {
...
double HelperFunction::pterr( TMuon* mu, bool isData){

        double pterr = mu->ptErr;
...
/*
        ...
        gsfP4.SetPtEtaPhiM(elec->calibPt, elec->eta, elec->phi, 0.000511);
        double pterr = perr*elec->calibPt/gsfP4.P();

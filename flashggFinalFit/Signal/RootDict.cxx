...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::LCRooAddition*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("LCRooAddition", ::LCRooAddition::Class_Version(), "interface/LCRooAddition.h", 29,
                  typeid(::LCRooAddition), DefineBehavior(ptr, ptr),
   ...
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_(Init) = GenerateInitInstanceLocal((const ::LCRooAddition*)0x0); R__UseDummy(_R__UNIQUE_(Init));
} // end of namespace ROOT
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::LCRooChi2Var*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("LCRooChi2Var", ::LCRooChi2Var::Class_Version(), "interface/LCRooChi2Var.h", 24,
                  typeid(::LCRooChi2Var), DefineBehavior(ptr, ptr),
   ...
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_(Init) = GenerateInitInstanceLocal((const ::LCRooChi2Var*)0x0); R__UseDummy(_R__UNIQUE_(Init));
} // end of namespace ROOT
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::LCRooAddition*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::LCRooChi2Var*)0x0)->GetClass(); }
   return fgIsA;
}
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<int,RooDataHist*>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("map<int,RooDataHist*>", -2, "map", 96,
                  typeid(map<int,RooDataHist*>), DefineBehavior(ptr, ptr),
   ...
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_(Init) = GenerateInitInstanceLocal((const map<int,RooDataHist*>*)0x0); R__UseDummy(_R__UNIQUE_(Init));
...
namespace ROOT {
   ...
   static void *new_maplEintcORooDataHistmUgR(void *p) {
      return  p ? ::new((::ROOT::TOperatorNewHelper*)p) map<int,RooDataHist*> : new map<int,RooDataHist*>;
   }
   static void *newArray_maplEintcORooDataHistmUgR(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::TOperatorNewHelper*)p) map<int,RooDataHist*>[nElements] : new map<int,RooDataHist*>[nElements];
   }
   // Wrapper around operator delete
   static void delete_maplEintcORooDataHistmUgR(void *p) {
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<int,LCRooChi2Var*>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("map<int,LCRooChi2Var*>", -2, "map", 96,
                  typeid(map<int,LCRooChi2Var*>), DefineBehavior(ptr, ptr),
   ...
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_(Init) = GenerateInitInstanceLocal((const map<int,LCRooChi2Var*>*)0x0); R__UseDummy(_R__UNIQUE_(Init));
...
namespace ROOT {
   ...
   static void *new_maplEintcOLCRooChi2VarmUgR(void *p) {
      return  p ? ::new((::ROOT::TOperatorNewHelper*)p) map<int,LCRooChi2Var*> : new map<int,LCRooChi2Var*>;
   }
   static void *newArray_maplEintcOLCRooChi2VarmUgR(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::TOperatorNewHelper*)p) map<int,LCRooChi2Var*>[nElements] : new map<int,LCRooChi2Var*>[nElements];
   }
   // Wrapper around operator delete
   static void delete_maplEintcOLCRooChi2VarmUgR(void *p) {
...
"/uscms_data/d3/jbueghly/combine/custom_flashgg/CMSSW_7_4_7/src",
"/cvmfs/cms.cern.ch/slc6_amd64_gcc491/lcg/root/6.02.00-odfocd5/include",
"/uscms_data/d3/jbueghly/combine/custom_flashgg/CMSSW_7_4_7/src/flashggFinalFit/Signal/",
0
    };
...
class __attribute__((annotate(R"ATTRDUMP(Chi^2 function of p.d.f w.r.t a binned dataset)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$interface/LCRooAddition.h")))  LCRooChi2Var;

...
do 
    ...
    ./bin/fTest -i workspaces_MY/WS_combined.root --saveMultiPdf pdfs_MY_sideband/pdf_combined_${maxVal}.root -D plots_MY_sideband/combined/${maxVal} -f 6789,501,502,503,1,2,3,4 --isData 1 --verbose 1 --channel combined --era combined --rangeMin 115 --rangeMax $maxVal --sidebandOnly 
